...
state Numeric
{
    state_entry()
	{
        ...
        if(DIALOG_NUMERIC_INTEGER)
            vMessage = osReplaceString(DIALOG_MENU_MESSAGE, "{VALUE}", (string)((integer)DIALOG_NUMERIC_VALUE), -1, 0);
        else vMessage = osReplaceString(DIALOG_MENU_MESSAGE, "{VALUE}", (string)DIALOG_NUMERIC_VALUE, -1, 0);
